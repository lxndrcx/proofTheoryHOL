...
(* Theorem FINITE_BAG_MERGE `∀Γ Γ'. FINITE_BAG Γ ∧ FINITE_BAG Γ' ==> FINITE_BAG (BAG_MERGE Γ Γ')` ( *)
...
val Gm_lw_BAG_MERGE = Q.prove(`!Γ₁ A. Gm Γ₁ A ==> !Γ₂. FINITE_BAG Γ₂ ==> Gm (BAG_MERGE Γ₂ Γ₁) A`,
rw[] >> irule Gm_lw >>
